          ...
          <table className="w-full hidden md:table">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700">Toplam Satış</th>
                <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700">Son Satış</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredCustomers.map((customer) => (
                <tr key={customer.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900 font-semibold">{customer.total_sales || 0}</td>
                  <td className="px-6 py-4 text-sm text-gray-500">
          ...
          filteredCustomers.map((customer) => {
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  <p className={`text-xs mb-1 ${isSelected ? 'text-white/70' : 'text-gray-400'}`}>Toplam Satış</p>
                ...
                {customer.last_sale_date && (
                  <div>
                    <p className={`text-xs mb-1 ${isSelected ? 'text-white/70' : 'text-gray-400'}`}>Son Satış</p>
                    <p className={isSelected ? 'text-white' : 'text-gray-700'}>
